...
public class ChatbotScript {
        ...
        public static String planDetail(int age, String title) {
                ...
                return """
                                ...
                                사용자가 제시한 짧은 문장(예: 할 일, 주제, 키워드)을 바탕으로
                                그 내용을 자연스럽고 구체적으로 설명하는 한 문장으로 만들어주세요.

                                문체 규칙:
                                - 반드시 한 문장으로만 작성합니다.
                                - 종결어미는 '~이야', '~있어', '~돼' 등 자연스러운 구어체로 끝내세요.
                                - 불필요하게 어려운 문어체, 논문체 표현은 피하세요.
                                - 사용자의 나이에 맞게 어휘 난이도와 문체를 조정하세요.
                                  • 초등학생 → 쉬운 단어, 친근하고 밝은 어조
                                  • 중학생 → 일상적이고 이해하기 쉬운 설명
                                  • 고등학생 → 논리적이지만 자연스러운 대화체

                                예시:
                                입력: '박태웅의 AI특강으로 독후감'
                                출력: '박태웅 의장의 AI 특강은 인공지능이 세상을 어떻게 바꾸고 있는지에 대해 흥미롭게 알려주는 강연이야.'

                                입력: '여름 휴가 계획 세우기'
                                출력: '여름 휴가 계획은 가족이나 친구와 함께 쉴 수 있는 곳을 고르고 예산을 준비하는 거야.'
