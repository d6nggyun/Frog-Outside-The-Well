...
public record TodoRequest(
                ...
                @Schema(description = "업무 유형", example = "PREVIEW_REVIEW", allowableValues = {
                                "PREVIEW_REVIEW", "HOMEWORK", "TEST_STUDY", "PERFORMANCE_ASSESSMENT", "CAREER_ACTIVITY", "ETC" })
                @NotNull(message = "업무 유형이 비어있습니다.")
                TodoType todoType
